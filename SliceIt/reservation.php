...
if(isset($_SESSION['user_id'])){
    ...
    if(isset($_GET['error3'])){
        ...
        else if($_GET['error3'] == "invalidcomments") {   
            echo '<h5 class="bg-danger text-center">Invalid comments, Please try again!</h5>';
        }
    ...
    <div class="signup-form">
        <form action="includes/reservation.inc.php" method="post">
            ...
            <div class="form-group">
                ...
                <small class="form-text text-muted">Telephone must be valid</small>
            </div>
            <div class="form-group">
